export const About = () => {
    return (
      <div className="about">
        ...
        <p>I'm hard-working and I'm not afraid to face a challenge. I would describe myself as an honest and open person.

My favorite hobby is traveling. I like to visit new countries, cities and places around the world. Along with this I like ride an attractions and always visit amusement parks.</p>
      </div>
    );
  };
